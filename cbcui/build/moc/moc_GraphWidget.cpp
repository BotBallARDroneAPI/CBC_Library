...
**
** Created: Mon Oct 8 15:54:09 2012
...
static const char qt_meta_stringdata_GraphWidget[] = {
    "GraphWidget\0\0x,y,z\0addValues(int,int,int)\0"
    "resetScan()\0"
};
...
void GraphWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->addValues((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        case 1: _t->resetScan(); break;
        default: ;
        }
    }
}
